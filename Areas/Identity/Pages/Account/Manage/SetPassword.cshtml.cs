...
namespace SYGESTMunicipal.Areas.Identity.Pages.Account.Manage
{
    public class SetPasswordModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(100, ErrorMessage = "La {0} Debe Tener al Menos {6} y Máximo {1} Caracteres de Largo.", MinimumLength = 6)]
            ...
            [Compare("NewPassword", ErrorMessage = "La Contraseña y la Conformación de Contraseña No Coinciden.")]
